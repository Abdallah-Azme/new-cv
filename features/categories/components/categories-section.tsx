      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {categories.map((key) => {
          return (
            <Card
              key={key}
              className="group relative rounded-[8px] border border-[#d4d4d4] bg-white transition-all hover:border-[#4BB7E7] hover:bg-[linear-gradient(180deg,#2D7494_0%,#398DB3_100%)] hover:shadow-[0_0_0_5px_rgba(255,255,255,1),0_0_0_4px_rgba(194,227,250,1),0_4px_5px_rgba(75,183,231,0.15),0_10px_13px_rgba(75,183,231,0.22),0_24px_32px_rgba(75,183,231,0.19)] cursor-pointer min-h-[220px]"
            >
        ...
        <Card className="rounded-[8px] border border-[#4BB7E7] bg-[linear-gradient(180deg,#2D7494_0%,#398DB3_100%)] text-white shadow-[0_0_0_5px_rgba(255,255,255,1),0_0_0_4px_rgba(194,227,250,1),0_4px_5px_rgba(75,183,231,0.15),0_10px_13px_rgba(75,183,231,0.22),0_24px_32px_rgba(75,183,231,0.19)] min-h-[220px]">
          <CardContent className="flex h-full flex-col justify-between gap-6 p-6">
            ...
            <Button
              variant="outline"
              className="h-[44px] w-full justify-between rounded-[8px] border-white/40 bg-transparent text-white hover:bg-white/10 hover:text-white px-4"
            >
              {t("showMore")}
