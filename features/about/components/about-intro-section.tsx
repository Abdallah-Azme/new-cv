...
export function AboutIntroSection({ eyebrow, title, descriptionOne, descriptionTwo }: AboutIntroSectionProps) {
  return (
    <SectionShell className="bg-white py-[72px] lg:py-[84px]">
      <div className="space-y-10 lg:space-y-12">
        ...
        <div className="relative min-h-[320px] lg:min-h-[390px]">
          <div className="absolute bottom-0 ltr:left-0 rtl:right-0 h-[250px] w-[66%] overflow-hidden rounded-[12px] border border-[#dce9f4] shadow-[0_20px_42px_rgba(0,25,45,0.16)] lg:h-[300px]">
            <Image src="/home/content/news-2.png" alt="" fill className="object-cover" sizes="(min-width: 1024px) 48vw, 100vw" />
          </div>
          <div className="absolute top-[55px] ltr:right-[2%] rtl:left-[2%] h-[190px] w-[50%] overflow-hidden rounded-[12px] border-4 border-white shadow-[0_22px_40px_rgba(0,25,45,0.22)] lg:h-[235px]">
